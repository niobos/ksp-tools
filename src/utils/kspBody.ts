...
for(let body of [
    ...
    Body.create({name: 'Eve', orbitsAround: bodies['Kerbol'], mass: 1.2243980e23, radius: 700_000, solarDay: 81_661.857, atmosphere: 90_000, terrain: 7526, soi: 85_109_365, scienceSpaceBorder: 400e3, scienceAtmosphereBorder: 22e3}),
...
for(let body of [
    ...
    Body.create({name: 'Laythe', orbitsAround: bodies['Jool'], mass: 2.9397311e22, radius: 500_000, solarDay: 52_980.879, atmosphere: 50_000, terrain: 6079, soi: 3_723_645.8, scienceSpaceBorder: 200e3, scienceAtmosphereBorder: 10e3}),
