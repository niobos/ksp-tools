...
export class Engine extends Part {
    ...
    thrust(pressureAtm: number): number {
        if(pressureAtm == 0) return this.thrustCurve[1]
        else return this.thrustCurve[0]
    }
