...
export class Pod extends ReactionWheel {
    ...
    get consumptionHibernated() {
        ...
        // else:
        return this.consumption.copy({El: this.consumption.amount.El * this.hibernateMultiplier})
    }
}
...
export const probeCores = {
    'Mk1 Cockpit': Pod.create({
        ...
        mass: 1.28,
        size: new Set([Size.SMALL]),
        content: new Resources({El: 50, Mono: 7.5}),
        maxTorque: [10, 10, 10],
    ...
    'Mk2 Cockpit': Pod.create({
        ...
        content: new Resources({El: 150, Mono: 15}),
        maxTorque: [15, 15, 15],
    ...
    'Mk2 Inline Cockpit': Pod.create({
        ...
        mass: 2.10,
        size: new Set([Size.MK2]),
        content: new Resources({El: 150, Mono: 25}),
        maxTorque: [15, 15, 15],
        torquePowerRequirement: 0.033,
        crew: 2,
    ...
    'Mk3 Cockpit': Pod.create({
        ...
        content: new Resources({El: 500, Mono: 100}),
        maxTorque: [40, 40, 20],
    ...
    'Mk1 Command Pod': Pod.create({
        ...
        content: new Resources({El: 50, Mono: 10}),
        maxTorque: [5, 5, 5],
    ...
    'Mk1-3 Command Pod': Pod.create({
        ...
        content: new Resources({El: 150, Mono: 30}),
        maxTorque: [15, 15, 15],
        torquePowerRequirement: 0.030,
        crew: 3,
    ...
    'Mk1 Lander Can': Pod.create({
        ...
        mass: 0.66,
        size: new Set([Size.SMALL]),
        content: new Resources({El: 50, Mono: 15}),
        maxTorque: [3, 3, 3],
    ...
    'Mk2 Lander Can': Pod.create({
        ...
        mass: 1.515,
        size: new Set([Size.LARGE]),
        content: new Resources({El: 100, Mono: 40}),
        maxTorque: [15, 15, 15],
        torquePowerRequirement: 0.050,
        crew: 2,
    ...
    'PPD-12 Cupola Module': Pod.create({
        ...
        mass: 1.80,
        size: new Set([Size.LARGE, Size.SMALL]),
        content: new Resources({El: 200, Mono: 10}),
        maxTorque: [9, 9, 9],
        torquePowerRequirement: 0.100,
        crew: 1,
    ...
    'Munar Excursion Module (M.E.M.)': Pod.create({
        ...
        content: new Resources({El: 150, LF: 54, Ox: 66, Mono: 30}),
        crew: 2,
    ...
    'Probodobodyne RoveMate': Pod.create({
        ...
        mass: 0.15,
        size: new Set([Size.SMALL]),
        consumption: new Resources({El: 2.40 / 60}),
        hibernateMultiplier: .25,
        content: new Resources({El: 120}),
    ...
    'Probodobodyne Stayputnik': Pod.create({
        ...
        mass: 0.05,
        size: new Set([Size.TINY]),
        consumption: new Resources({El: 1.67 / 60}),
        hibernateMultiplier: .001,
        content: new Resources({El: 10}),
    ...
    'Probodobodyne QBE': Pod.create({
        ...
        mass: 0.07,
        size: new Set([Size.TINY]),
        consumption: new Resources({El: 1.50 / 60}),
        hibernateMultiplier: .01,
        content: new Resources({El: 5}),
    ...
    'Probodobodyne OKTO': Pod.create({
        ...
        mass: 0.10,
        size: new Set([Size.TINY]),
        consumption: new Resources({El: 1.20 / 60}),
        hibernateMultiplier: .01,
        content: new Resources({El: 10}),
        maxTorque: [0.3, 0.3, 0.3],
        torquePowerRequirement: 0.1,
    ...
    'Probodobodyne OKTO2': Pod.create({
        ...
        mass: 0.04,
        size: new Set([Size.TINY]),
        consumption: new Resources({El: 1.80 / 60}),
        hibernateMultiplier: .01,
        content: new Resources({El: 5}),
    ...
    'Probodobodyne HECS2': Pod.create({
        ...
        mass: 0.20,
        size: new Set([Size.SMALL]),
        consumption: new Resources({El: 3.00 / 60}),
    ...
    'RC-001S Remote Guidance Unit': Pod.create({
        ...
        mass: 0.10,
        size: new Set([Size.SMALL]),
        consumption: new Resources({El: 3.0 / 60}),
        hibernateMultiplier: .004,
        content: new Resources({El: 15}),
    ...
    'RC-L01 Remote Guidance Unit': Pod.create({
        ...
        mass: 0.50,
        size: new Set([Size.LARGE]),
        consumption: new Resources({El: 4.80 / 60}),
        hibernateMultiplier: .00125,
        content: new Resources({El: 30}),
    ...
    'MPO Probe': Pod.create({
        ...
        consumption: new Resources({El: 3.00 / 60}),
        hibernateMultiplier: .002,
        content: new Resources({LF: 45, Ox: 55, El: 1000}),
        maxTorque: [6, 6, 6],
        torquePowerRequirement: 0.050,
    ...
    'MTM Stage': Pod.create({
        ...
        consumption: new Resources({El: 1.80 / 60}),
        hibernateMultiplier: .01,
        content: new Resources({Xe: 3800, El: 4000}),
        maxTorque: [12, 12, 12],
        torquePowerRequirement: 0.050,
