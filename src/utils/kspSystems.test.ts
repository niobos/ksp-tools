import kspSystems, {Body} from "./kspSystems"
...
describe('Stock', () => {
    it('should contain Kerbin', () => {
        expect(kspSystems["Stock"].bodies["Kerbin"]).toHaveProperty("name", "Kerbin")
    })
    it('should have Kerbin located at the correct position around Kerbol', () => {
        compareAngle(angleOfBody(kspSystems["Stock"].bodies["Kerbin"]), 180)
    })
    it('should have Mun located at the correct position around Kerbin', () => {
        compareAngle(angleOfBody(kspSystems["Stock"].bodies["Mun"]), 100)
    })
    it('should have Jool located at the correct position around Kerbol', () => {
        compareAngle(angleOfBody(kspSystems["Stock"].bodies["Jool"]), 60)
    })
})

describe("OPM", () => {
    it('should contain Kerbin', () => {
        expect(kspSystems["Outer Planets"].bodies["Kerbin"]).toHaveProperty("name", "Kerbin")
    })
    it('should have Kerbin located at the correct position around Kerbol', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Kerbin"]), 180)
    })
    it('should have Mun located at the correct position around Kerbin', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Mun"]), 100)
    })
    it('should have Jool located at the correct position around Kerbol', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Jool"]), 60)
    })
    it('should have Sarnus located at the correct position around Kerbol', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Sarnus"]), -10)
    })
    it('should have Hale located at the correct position around Sarnus', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Hale"]), 55)
    })
    it('should have Eeloo located at the correct position around Sarnus', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Eeloo"]), 135)
    })
    it('should have Neidon located at the correct position around Kerbol', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Neidon"]), 30)
    })
    it('should have Nissee located at the correct position around Neidon', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Nissee"]), -140)
    })
    it('should have Thatmo located at the correct position around Neidon', () => {
        compareAngle(angleOfBody(kspSystems["Outer Planets"].bodies["Thatmo"]), 85)
    })
})
