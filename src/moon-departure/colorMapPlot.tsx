    ...
    export default function ColorMapPlot<Type>(props: ColorMapPlotProps<Type>) {
        ...
        const [lastPaintedResult_, setLastPaintedResult] = useState(-1)
        const [paintState_, setPaintState] = useState(null)
        ...
        const doDraw = async () => {
            const thisCalcVersion = ++calcVersion
            //console.log(`Starting draw ${thisCalcVersion}`)
            ...
            while(true) {
                ...
                if(calcVersion > thisCalcVersion) {
                    //console.log(`Abandoning draw ${thisCalcVersion}`)
                    return
                }
            }
        ...
        let lastPaintedResult = lastPaintedResult_
        let paintState = paintState_
        useEffect(() => {
                lastPaintedResult = -1
                paintState = null
            },
